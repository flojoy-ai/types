...
const PlotlyComponent = (props) => {
    ...
    return (_jsx(Plot, { data: data, layout: Object.assign(Object.assign(Object.assign(Object.assign({}, layout), defaultPlotLayout), { showlegend: !isThumbnail }), (isThumbnail && isMatrix && getSizeForMatrix())), useResizeHandler: useResizeHandler, config: { displayModeBar: false, staticPlot: isThumbnail && !is3dPlot }, style: isMatrix && isThumbnail ? getSizeForMatrix() : style }));
};
